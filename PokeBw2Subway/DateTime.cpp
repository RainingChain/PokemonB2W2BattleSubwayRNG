...
int Time::addSeconds(long long seconds)
{
    long long md2 = md + seconds;
...
int Time::secondsTo(const Time &other) const
{
    return md - other.md;
}
...
{
    long long daysTo = this->date.daysTo(other.date);
    return daysTo * 3600 * 24 + (long long)this->time.secondsTo(other.time);
}

int DateTime::addSeconds(long long seconds)
{
